...
<body> 
<form method="post" action="ManageGardenServlet">
<div id="header">
<center>	
<br>
...
<center>
<form  method="post" action="ManageGardenServlet">
<input type="submit" name="submit" value="View Garden">
<input type="hidden" name="viewlist" value="viewlist" >
</form>
<%
List<report> reports=(List<report>)request.getAttribute("viewlist");
if(reports !=null)
{
	if(reports.size()>0)
	{
...
<table width="60%" border="1">
	...
	<form method="post" action="ManageGardenServlet">
		<table>
	<tr>
	<td >Delete Plant from Garden</td>
	</tr>
	<tr>
	<td>Enter Plant Name:&nbsp;<input type="text" name="deleteplantname"/></td>
	<td>Enter Garden Number:&nbsp;<input type="text" name="deletegardennumber"/></td>
	...
	<br><br>
	<%
							String errormessage=(String)request.getAttribute("managegardenresult");
	...
	<table>
	<tr>
	<td >Adding Plant to Garden</td>
	</tr>
	<tr>
	<td >Enter Plant Name:&nbsp;<input type="text" name="addplantname"/></td>
	<td>Enter Garden Number:&nbsp;<input type="text" name="addgardennumber"/></td>
