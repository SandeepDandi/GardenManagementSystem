...
<body>
	<form method="post" action="ExpertViewReportServlet"
		onsubmit="return f()">
		<div id="header">
			<center>
				<br>
				...
				<tr>
					<td>
						<ul>
							...
							<li id="first" class="active"><a href="expertviewreport.jsp">View
									Reports</a></li>
						</ul>
					</td>
					<td align="right">
			...
			<div id="primarycontainer">
				<div id="primarycontent">
					<center>
						...
						<br> Enter User Email:&nbsp;<input type="text"
							name="useremail" /> <input type="submit" name="submit"
							value="Submit"> <br>
						<%
							String errormessage = (String) request
									.getAttribute("expertviewreportresult");
						...
						%>
						<%
							List<report> viewreport = (List<report>) request
									.getAttribute("expertviewreport");
							if (viewreport != null) {
								if (viewreport.size() > 0) {
						%>
